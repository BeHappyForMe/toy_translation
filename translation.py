...
def main():
    ...
    parse.add_argument("--do_train", action="store_true", help="是否微调训练模型")
    parse.add_argument("--do_test", default=True, action="store_true", help="是否测试模型")
    parse.add_argument("--do_translate", action="store_true", help="是否运行模型进行翻译")
    ...
    parse.add_argument("--warmup_steps", default=0, type=int, help="学习率预热步数")
    ...
    parse.add_argument("--beam_size", default=5, type=int,help="beam search参数")
    parse.add_argument("--max_decoding_time_step", default=20, type=int, help="最大解码长度")
